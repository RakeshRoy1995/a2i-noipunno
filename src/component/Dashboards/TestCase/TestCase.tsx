      ...
      >
        ...
        <View >
          <View wrap={true} style={{ fontFamily: "Nikosh", display: "flex", flexDirection: "column", gap: "5", padding: "5px" }}>
            ...
            <View style={{ backgroundColor: "skyblue", border: "1px", display: "flex", flexDirection: "column", gap: 2 }}>
              <Text style={{ textDecoration: "underline", marginHorizontal: "auto", marginVertical: "10px", fontSize: "16px", }}>
                This is English Paragraph
              </Text>
              <Text style={{ lineHeight: "1.5px", fontSize: "11px", fontWeight: "normal", }}>
                Sit amet consectetur adipisicing elit. Unde aliquam nesciunt ullam quae iure rem ab facilis, nisi deleniti obcaecati, quod perspiciatis iusto. Harum deserunt voluptas optio architecto, doloribus enim!
              </Text>
            </View>
