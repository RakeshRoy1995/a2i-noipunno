...
import teacherassistance from "../assets/login_page_materials/sikkhok-sohayika.png"
        ...
        <div>
            ...
            <div className="footer-card-custom d-flex justify-content-center help-desk-desktop">
                <div className="d-flex align-items-center">
                    ...
                    <div className="d-flex justify-content-center" >
                        <a href="https://play.google.com/store/apps/details?id=com.a2i.teachersguide" target="_blank">
                            <img src={teacherassistance} style={{ cursor: 'pointer', borderRadius: '100px', width: '55px' }} data-tooltip="শিক্ষক সহায়িকা" alt="শিক্ষক সহায়িকা" />
                        </a>
                    </div>
                    <div className="d-flex justify-content-center" >
