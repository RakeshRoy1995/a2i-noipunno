      ...
      <div id={"contentToConvert_"}>
        <div className="bg-white">
          ...
          >
            ...
            <div className="row mx-1 mt-2 mb-5">
              <div className="col-sm-6 col-md-12 mb-1">
                <div className="d-flex std-identity">
                  <div className="">প্রতিষ্ঠানের নাম</div>
                  <div className="">: {instititute?.institute_name}</div>
                </div>
              </div>
              <div className="col-sm-6 col-md-6 mb-1 ">
                <div className="d-flex std-identity">
                  <div className="">শিক্ষার্থীর নাম</div>
                  <div className="">
                    {" "}
              ...
              <div className="col-sm-6 col-md-6 mb-1 ">
                <div className="d-flex std-identity">
                  <div className="">শিক্ষার্থীর আইডি</div>
                  <div className="">
                    {" "}
        ...
        <div className="page-border-desing bg-white my-1">
          ...
          >
                  ...
                  <div className="card border border-2 border-dark my-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        ...
                        এবং নিজের বক্তব্য বোোঝাতে বিভিন্ন অর্থবৈচিত্রর্যমূলক
                        বাক্য তৈরি করেছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
              ...
              <div className="row">
                ...
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative pb-3">
                  <div className="card border border-2 border-dark my-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        Uses appropriate vocabulary and expressions as required
                        in the context
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
              ...
              <div className="row">
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative py-3 ">
                  <div className="card border border-2 border-dark my-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        বৈজ্ঞানিক অনুসন্ধানের ক্ষেত্রে তথ্য প্রমাণ ও
                        বস্তুনিষ্ঠতার উপর জোোর দিয়েছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
                      <div className="assessment-mark-dark" />
                ...
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative py-3">
                  <div className="card border border-2 border-dark my-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        বিভিন্ন প্রাকৃতি ক ঘটনায় শক্তির স্থানান্তর অনুসন্ধান
                        করেছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
              ...
              <div className="row">
                ...
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative py-3">
                  <div className="card border border-2 border-dark my-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        ব্যক্তিগত প্রয়োোজনে ডিজিটাল মাধ্যম ব্যবহার করে জরুরি
                        সেবা গ্রহণের জন্য যোোগাযোোগ করেছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
                      <div className="assessment-mark-dark" />
              ...
              <div className="row">
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative pb-5">
                  <div className="card border border-2 border-dark my-3 mb-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        লিখিত ও অলিখিত উৎস থেকে তথ্য নিয়ে বিভিন্ন দৃষ্টিকোোণ
                        থেকে নিজের আত্মপরিচয় ও ইতিহাস অন্বেষণ করেছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
                      <div className="assessment-mark-dark" />
                ...
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative pb-5">
                  <div className="card border border-2 border-dark my-3 mb-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        বিভিন্ন উৎস থেকে তথ্য নিয়ে মুক্তিযুদ্ধে সর্বস্তরের
                        মানুষের অবদান অনুসন্ধান করেছে{" "}
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
                      <div className="assessment-mark-dark" />
                  ...
                  <div className="card border border-2 border-dark my-3 mb-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        ...
                        কীভাবে মানুষের অবস্থান ও ভূমিকা নির্ধারণ করে তা
                        অনুসন্ধান করেছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
              ...
              <div className="row">
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative pb-3">
                  <div className="card border border-2 border-dark my-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        নিজের পছন্দ ও সক্ষমতা বিবেচনায় জীবনের লক্ষ্য নির্ধারণ
                        করে দায়িত্বশীল কাজে নিজেকে সম্পৃক্ত করতে পেরেছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
                      <div className="assessment-mark-dark" />
                ...
                <div className="col-sm-6 col-md-6 col-lg-4 position-relative pb-3">
                  <div className="card border border-2 border-dark my-3 h-100">
                    ...
                    >
                      <h4 className="report-card-design-subject-assessment text-center">
                        নির্দিষ্ট পেশা সম্পর্কে মৌলিক ধারণা ও আগ্রহ প্রদর্শন
                        করতে পেরেছে
                      </h4>
                    </div>
                    <div className="d-flex position-absolute bottom-0 w-100">
            ...
            <div style={{ pageBreakInside: "avoid" }}>
              ...
              <div className="row">
                <div className="col-sm-6 col-md-6 col-lg-6 position-relative pb-5">
                  ...
                  <div className="d-flex gap-2">
                    ...
                    <div className="d-flex gap-2 align-items-center">
                      ...
                      >
                        <div className="ps-3"> = </div>
                        <div className="ps-5">অর্জনমুখী  (Achieving)</div>
                      </div>
                    </div>
                    <div className="d-flex gap-2">
                      <div className="d-flex gap-2 indicators-check-boxes">
                      ...
                      >
                        <div className="ps-3"> = </div>
                        <div className="ps-5">অগ্রগামী (Advancing)</div>
                      </div>
                    </div>
                    <div className="d-flex gap-2">
                      <div className="d-flex gap-2 indicators-check-boxes">
                      ...
                      >
                        <div className="ps-3"> = </div>
                        <div className="ps-5">সক্রিয় (Activating)</div>
                      </div>
                    </div>
                    <div className="d-flex gap-2">
                      <div className="d-flex gap-2 indicators-check-boxes">
                      ...
                      >
                        <div className="ps-3"> = </div>
                        <div className="ps-5">অনুসন্ধানী (Exploring)</div>
                      </div>
                    </div>
                    <div className="d-flex gap-2">
                      <div className="d-flex gap-2 indicators-check-boxes">
                      ...
                      >
                        <div className="ps-3"> = </div>
                        <div className="ps-5">বিকাশমান (Developing)</div>
                      </div>
                    </div>
                    <div className="d-flex gap-2">
                      <div className="d-flex gap-2 indicators-check-boxes">
                      ...
                      >
                        <div className="ps-3"> = </div>
                        <div className="ps-5">প্রারম্ভিক (Elementary)</div>
                      </div>
                    </div>
                    
                  </div>
                </div>
                <div className="col-sm-6 col-md-6 col-lg-6 position-relative py-5 px-5">
            ...
            <div style={{ pageBreakInside: "avoid" }}>
              <div className="row">
                <div className="col-sm-12 col-md-6 py-3 px-5">
