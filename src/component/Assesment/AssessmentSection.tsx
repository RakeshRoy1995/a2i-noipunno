...
//             pi_attr={pi_attr}
//             showDetailsshikhonKalinMullayon={showDetailsshikhonKalinMullayon}
//             shikhonKalinMullayon_sannasik_barsik={
//               shikhonKalinMullayon_sannasik_barsik
//             }
...
// export default AptBehavAssessment
    ...
    <>
     {!ShowProfile && (
      <>
        ...
        {showSkillBehaibor && parodorshita_acoron_tab === 0 && (
          <ParodorshitaComponent
            pi_selection={pi_selection}
            teacher_uid={teacher_uid}
            Student={Student}
            ...
            Mullayon_name={Mullayon_name}
            shikhonKalinMullayon={shikhonKalinMullayon}
            setshowDetailsshikhonKalinMullayon={setshowDetailsshikhonKalinMullayon}
          />
        )}

{showSkillBehaibor && parodorshita_acoron_tab === 1 && (
          <AcorongotoComponent
            teacher_uid={teacher_uid}
            teacher={teacher}
            Student={Student}
