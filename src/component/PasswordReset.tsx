                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        {showVarify && (
                          <>
                            ...
                            <p className="login-field-title mt-2 mb-2">কোন মাধ্যমে OTP পেতে চান?</p>
                            <div className="d-flex gap-2">
                              <input type="radio" id="mobileRadio" name="contactMethod" value="mobile" checked />
                              <label htmlFor="mobileRadio">মোবাইল</label>
                              <input type="radio" id="emailRadio" name="contactMethod" value="email" />
